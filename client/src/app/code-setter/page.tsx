      ...
      <div className="w-full h-full flex flex-col gap-4 p-4 justify-evenly">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex justify-between">
            <div className="text-2xl font-bold">Set Coding Questions</div>
        ...
        <div className="flex flex-col gap-5 h-full overflow-y-auto">
          {questionLength.map((index) => (
            ...
            >
              <CodePaper addQuestion={addQuestion}/>
            </div>
          ))}
        ...
        <div className=" flex justify-end">
            <button onClick={()=>setQuestionLength([...questionLength,1])} className="bg-white p-2 rounded-lg  hover:bg-black hover:text-yellow-200 hover:cursor-pointer transition-all duration-500">Add Coding Question</button>
          </div>
